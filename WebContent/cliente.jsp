...
<div class="card text-white bg-secondary mb-3" style="max-width: 100%;">
  <div class="card-header"><h5 class="card-title">Cadastro de Cliente</h5></div>
  <div class="card-body">
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="logradouro" placeholder="Logradouro" style="max-width: 35%;">
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput2">Número:</label>
    <input type="text" class="form-control" name="numero" placeholder="Número" style="max-width: 8%;">
  </div>
   <div class="form-group">
    <label for="formGroupExampleInput2">Bairro:</label>
    <input type="text" class="form-control" name="bairro" placeholder="Bairro" style="max-width: 35%;">
  </div>
     <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="telefone" placeholder="(00)0000-0000" style="max-width: 35%;">
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput2">CPF:</label>
    <input type="text" class="form-control" name="cpf" placeholder="000.000.000-00" style="max-width: 35%;">
  </div>
   <div class="form-group">
    <label for="formGroupExampleInput2">RG:</label>
    <input type="text" class="form-control" name="rg" placeholder="00.000.000-0" style="max-width: 35%;">
  </div>
  	  SEXO: &nbsp;&nbsp;&nbsp;
  <div class="form-check form-check-inline">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="dataNascimento" placeholder="00/00/0000" style="max-width: 10%;">
  </div>
  <div class="form-group">
